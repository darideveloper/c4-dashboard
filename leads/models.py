...
class QuoteCompany(models.Model):
    ...
    HAS_CAMERAS_CHOICES = (
        ("yes", "Sí, solo quiero monitoreo"),
        ("no", "No, quiero instalación también"),
        ("maintenance", "Solo quiero mantenimiento")
    )
    ...
    has_cameras = models.CharField(
        max_length=20, choices=HAS_CAMERAS_CHOICES, verbose_name="tiene cámaras"
    )
